...
if __name__ == '__main__':
    ...
    # pid = str(os.getpid())
    i = 0
    txt = np.loadtxt('parameter_BE1.txt')
    for i in range(2):
        ...
        write_result(r'./pred_result_valid_BE1.txt', l1, l2, h1, b1, h2, b2, tA11, tA12, tA13, tA14,
                     ypred1, ypred2, ypred3, ypred4, ypred5, ypred6, ypred7, ypred8)
        write_result2(r'./pred_result_valid_BE1.txt', ypred1, ypred2, ypred3, ypred4, ypred5, ypred6, ypred7, ypred8)
