...
def gene_pic(A, B, save_dir1, h1, h2):
    ...
    if ln > 0:
        ...
        plt.fill_between([0, 11], 0, 3, color=color4((fc - 18) / 24), alpha=0.5, linewidth=0)
        plt.fill_between([4, 7], 3, 11, color=color4((fc - 18) / 24), alpha=0.5, linewidth=0)
        plt.plot(line1[0], line1[1], c=color2(h1 * 1.16), linewidth=10)
        plt.plot(line2[0], line2[1], c=color2(((c1 * 1000) - 20) / 80), linewidth=10)
        plt.plot(line3[0], line3[1], c=color2(((c1 * 1000) - 20) / 80), linewidth=10)
        plt.plot(line4[0], line4[1], c=color2(((c2 * 1000) - 20) / 80), linewidth=10)
        plt.plot(line5[0], line5[1], c=color2(h2 * 1.16), linewidth=10)
...
if __name__ == '__main__':
    ...
    # pid = str(os.getpid())
    i = 0
    txt = np.loadtxt('parameters_100.txt')
    for i in range(100):
        ...
        write_result(r'./pred_result_valid_100.txt', l1, l2, h1, b1, h2, b2, tA11, tA12, tA13, tA14,
                     ypred1, ypred2, ypred3, ypred4, ypred5, ypred6, ypred7, ypred8)
        write_result2(r'./pred_result_valid_100_2.txt', ypred1, ypred2, ypred3, ypred4, ypred5, ypred6, ypred7, ypred8)
